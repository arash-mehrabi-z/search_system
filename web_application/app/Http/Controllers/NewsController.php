...
class NewsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return $this->return_to_news_index('New news has been created.');
    }
    ...
    public function update(Request $request, News $news)
    {
        ...
        return $this->return_to_news_index('The news has been editted.');
    }
    ...
    public function return_to_news_index($message)
    {
        ...
        return view('news.index', ['news' => $last_five_news])->with('message', $message);
    }
}
